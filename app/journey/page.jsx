                    ...
                    <form onSubmit={handleAddEvent} className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500 min-h-[200px] resize-y"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500 min-h-[100px] resize-y"
